...
// PROJECT RESTRICTION: You can't use map, reduce, or filter to solve these problems.  
// Only use native JavaScript for loops.
...
// let lastCar = 0;
console.log(`Car ${inventory[inventory.length - 1].id} is a ${inventory[inventory.length - 1].car_make} ${inventory[inventory.length - 1].car_model}.`);
...
for (let car of inventory) {
    carModels.push(car.car_model.replace(/\w/, function(x){
...
let fancyCarList = JSON.stringify(BMWAndAudi);
console.log(fancyCarList);
